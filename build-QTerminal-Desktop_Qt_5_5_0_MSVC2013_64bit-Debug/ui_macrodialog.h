...
public:
    ...
    void setupUi(QDialog *MacroDialog)
    {
        if (MacroDialog->objectName().isEmpty())
            MacroDialog->setObjectName(QStringLiteral("MacroDialog"));
        MacroDialog->resize(517, 558);
        MacroDialog->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
...
"}"));
    ...
    {
        MacroDialog->setWindowTitle(QApplication::translate("MacroDialog", "Dialog", 0));
        groupBox->setTitle(QApplication::translate("MacroDialog", "GroupBox", 0));
        loadMacroButton->setText(QApplication::translate("MacroDialog", "Load", 0));
